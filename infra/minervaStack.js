...
class MinervaStack extends cdk.Stack {
    ...
    constructor(scope, id, props) {
        ...
        slackRoute
            .addResource("commands-async")
            .addMethod("POST", new apiGateway.LambdaIntegration(slackCommandsAsync));
        slackRoute
            .addResource("interactivity-sync")
            .addMethod("POST", new apiGateway.LambdaIntegration(interactivitySync));
        slackRoute
            .addResource("interactivity-async")
            .addMethod("POST", new apiGateway.LambdaIntegration(interactivityAsync));
